...
nix run nixpkgs#opencode           # 또는 github:paullbuth-arch/jarvis-herness-agent 로 최신 dev 브랜치
```
...
Jarvis 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) 에서 직접 다운로드하거나 [jarvis.dev/download](https://jarvis.dev/download) 를 이용하세요.
...
[agents](https://jarvis.dev/docs/agents) 에 대해 더 알아보세요.

### 문서

Jarvis 설정에 대한 자세한 내용은 [**문서**](https://jarvis.dev/docs) 를 참고하세요.
