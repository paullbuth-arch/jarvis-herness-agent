...
nix run nixpkgs#opencode           # veya en güncel geliştirme dalı için github:paullbuth-arch/jarvis-herness-agent
```
...
Jarvis ayrıca masaüstü uygulaması olarak da mevcuttur. Doğrudan [sürüm sayfasından](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) veya [jarvis.dev/download](https://jarvis.dev/download) adresinden indirebilirsiniz.
...
[Ajanlar](https://jarvis.dev/docs/agents) hakkında daha fazla bilgi edinin.

### Dokümantasyon

Jarvis'u nasıl yapılandıracağınız hakkında daha fazla bilgi için [**dokümantasyonumuza göz atın**](https://jarvis.dev/docs).
