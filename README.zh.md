...
nix run nixpkgs#opencode           # 或用 github:paullbuth-arch/jarvis-herness-agent 获取最新 dev 分支
```
...
Jarvis 也提供桌面版应用。可直接从 [发布页 (releases page)](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) 或 [jarvis.dev/download](https://jarvis.dev/download) 下载。
...
了解更多 [Agents](https://jarvis.dev/docs/agents) 相关信息。

### 文档

更多配置说明请查看我们的 [**官方文档**](https://jarvis.dev/docs)。
