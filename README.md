...
nix run nixpkgs#opencode           # or github:paullbuth-arch/jarvis-herness-agent for latest dev branch
```
...
Jarvis is also available as a desktop application. Download directly from the [releases page](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) or [jarvis.dev/download](https://jarvis.dev/download).
...
Learn more about [agents](https://jarvis.dev/docs/agents).

### Documentation

For more info on how to configure Jarvis, [**head over to our docs**](https://jarvis.dev/docs).
...
If you are working on a project that's related to Jarvis and is using "opencode" as part of its name, for example "opencode-dashboard" or "opencode-mobile", please add a note to your README to clarify that it is not built by the Jarvis team and is not affiliated with us in any way.
