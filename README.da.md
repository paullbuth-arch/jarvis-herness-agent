...
Jarvis findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) eller [jarvis.dev/download](https://jarvis.dev/download).
...
Læs mere om [agents](https://jarvis.dev/docs/agents).

### Dokumentation

For mere info om konfiguration af Jarvis, [**se vores docs**](https://jarvis.dev/docs).
