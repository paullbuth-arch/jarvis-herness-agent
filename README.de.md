...
nix run nixpkgs#opencode           # oder github:paullbuth-arch/jarvis-herness-agent für den neuesten dev-Branch
```
...
Jarvis ist auch als Desktop-Anwendung verfügbar. Lade sie direkt von der [Releases-Seite](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) oder [jarvis.dev/download](https://jarvis.dev/download) herunter.
...
Mehr dazu unter [Agents](https://jarvis.dev/docs/agents).

### Dokumentation

Mehr Infos zur Konfiguration von Jarvis findest du in unseren [**Docs**](https://jarvis.dev/docs).
