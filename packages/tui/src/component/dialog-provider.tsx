...
import type { ProviderAuthAuthorization, ProviderAuthMethod } from "@jarvis/sdk/v2"
    ...
    const value = await DialogPrompt.show(dialog, "Other", {
      ...
      description: () => (
        <text fg={theme.textMuted}>
          This only stores a credential. Configure the provider in jarvis.json to use it.
        </text>
      ),
    })
    ...
    <DialogPrompt
        ...
        ({
          opencode: (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://jarvis.wq7036/zen</span> to get a key
              </text>
            </box>
          ),
          "opencode-go": (
            <box gap={1}>
              ...
              <text fg={theme.text}>
                Go to <span style={{ fg: theme.primary }}>https://jarvis.wq7036/go</span> and enable OpenCode Go
              </text>
            </box>
          ),
      ...
      onConfirm={async (value) => {
        ...
        if (props.custom && !sync.data.provider_next.all.some((provider) => provider.id === props.providerID)) {
          toast.show({
            variant: "info",
            message: `Saved credential for ${props.providerID}. Configure it in jarvis.json to use it.`,
          })
          dialog.clear()
          return
        }
