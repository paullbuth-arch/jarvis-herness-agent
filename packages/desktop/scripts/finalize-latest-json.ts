...
const releaseId = process.env.JARVIS_RELEASE
if (!releaseId) throw new Error("JARVIS_RELEASE is required")

const version = process.env.JARVIS_VERSION
if (!version) throw new Error("JARVIS_VERSION is required")
