...
import { compile, emitEffectImported, emitPromise, write } from "@jarvis/httpapi-codegen"
        ...
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              ...
              import: 'import type { OpenCodeEventEncoded } from "@jarvis/protocol/groups/event"',
            },
          },
        }),
