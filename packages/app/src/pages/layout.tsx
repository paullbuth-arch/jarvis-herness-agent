...
import { getFilename } from "@jarvis/core/util/path"
import { Session } from "@jarvis/sdk/v2/client"
...
import { toaster } from "@jarvis/ui/toast"
...
import { retry } from "@jarvis/core/util/retry"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openLink("https://jarvis.wq7036/desktop-feedback")}
      renderPanel={() =>
