export const dict = {
  ...
  "dialog.provider.jarvis.note": "โมเดลที่คัดสรร รวมถึง Claude, GPT, Gemini และอื่น ๆ",
  "dialog.provider.jarvis.tagline": "โมเดลที่เชื่อถือได้และปรับให้เหมาะสม",
  "dialog.provider.jarvisGo.tagline": "การสมัครสมาชิกราคาประหยัดสำหรับทุกคน",
  ...
  "provider.connect.jarvisZen.visit.prefix": "เยี่ยมชม ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " เพื่อรวบรวมคีย์ API ของคุณ",
  ...
  "dialog.plugins.empty": "ปลั๊กอินที่กำหนดค่าใน jarvis.json",
  ...
  "error.chain.checkConfig": "ตรวจสอบการกำหนดค่าของคุณ (jarvis.json) ชื่อผู้ให้บริการ/โมเดล",
