export const dict = {
  ...
  "dialog.provider.jarvis.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.jarvis.tagline": "Modèles optimisés et fiables",
  "dialog.provider.jarvisGo.tagline": "Abonnement abordable pour tous",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Visitez ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " pour récupérer votre clé API.",
  ...
  "dialog.plugins.empty": "Plugins configurés dans jarvis.json",
  ...
  "error.chain.checkConfig": "Vérifiez votre configuration (jarvis.json) pour les noms de fournisseur/modèle",
