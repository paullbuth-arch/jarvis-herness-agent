export const dict = {
  ...
  "dialog.provider.jarvis.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.jarvis.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.jarvisGo.tagline": "Billigt abonnement for alle",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Besøg ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " for at hente din API-nøgle.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i jarvis.json",
  ...
  "error.chain.checkConfig": "Tjek dine konfigurations (jarvis.json) udbyder/modelnavne",
