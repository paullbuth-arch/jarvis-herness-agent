export const dict = {
  ...
  "dialog.provider.jarvis.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.jarvis.tagline": "Reliable optimized models",
  "dialog.provider.jarvisGo.tagline": "Low cost subscription for everyone",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Visit ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " to collect your API key.",
  ...
  "dialog.plugins.empty": "Plugins configured in jarvis.json",
  ...
  "wsl.onboarding.step.jarvis": "OpenCode",
  ...
  "wsl.onboarding.jarvisReadyIn": "OpenCode is ready in {{distro}}.",
  "wsl.onboarding.jarvisReady": "OpenCode is ready.",
  ...
  "wsl.onboarding.distroStatus.jarvisMissing": "OpenCode not installed",
  ...
  "error.chain.checkConfig": "Check your config (jarvis.json) provider/model names",
