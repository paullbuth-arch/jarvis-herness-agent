export const dict = {
  ...
  "dialog.provider.jarvis.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.jarvis.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.jarvisGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "provider.connect.jarvisZen.visit.prefix": "قم بزيارة ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في jarvis.json",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (jarvis.json)",
