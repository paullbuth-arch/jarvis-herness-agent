export const dict = {
  ...
  "dialog.provider.jarvis.note": "Modelos seleccionados incluyendo Claude, GPT, Gemini y más",
  "dialog.provider.jarvis.tagline": "Modelos optimizados y fiables",
  "dialog.provider.jarvisGo.tagline": "Suscripción económica para todos",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Visita ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " para obtener tu clave API.",
  ...
  "dialog.plugins.empty": "Plugins configurados en jarvis.json",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (jarvis.json)",
