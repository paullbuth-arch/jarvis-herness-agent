...
export const dict = {
  ...
  "dialog.plugins.empty": "In jarvis.json konfigurierte Plugins",
  ...
  "error.chain.checkConfig": "Überprüfen Sie Ihre Konfiguration (jarvis.json) auf Anbieter-/Modellnamen",
