export const dict = {
  ...
  "dialog.provider.jarvis.note": "Отобранные модели, включая Claude, GPT, Gemini и другие",
  "dialog.provider.jarvis.tagline": "Надежные оптимизированные модели",
  "dialog.provider.jarvisGo.tagline": "Доступная подписка для всех",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Посетите ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " чтобы получить ваш API ключ.",
  ...
  "dialog.plugins.empty": "Плагины настроены в jarvis.json",
  ...
  "error.chain.checkConfig": "Проверьте названия провайдера/модели в конфиге (jarvis.json)",
