export const dict = {
  ...
  "dialog.provider.jarvis.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.jarvis.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.jarvisGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Visite ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " para obter sua chave de API.",
  ...
  "dialog.plugins.empty": "Plugins configurados em jarvis.json",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (jarvis.json)",
