export const dict = {
  ...
  "dialog.provider.jarvis.note": "Wyselekcjonowane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.jarvis.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.jarvisGo.tagline": "Tania subskrypcja dla każdego",
  ...
  "provider.connect.jarvisZen.visit.prefix": "Odwiedź ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": ", aby odebrać swój klucz API.",
  ...
  "dialog.plugins.empty": "Wtyczki skonfigurowane w jarvis.json",
  ...
  "error.chain.checkConfig": "Sprawdź swoją konfigurację (jarvis.json) nazwy dostawców/modeli",
