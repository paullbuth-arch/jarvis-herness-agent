export const dict = {
  ...
  "dialog.provider.jarvis.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.jarvis.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.jarvisGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "provider.connect.jarvisZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.jarvisZen.visit.prefix": " ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  ...
  "dialog.plugins.empty": "jarvis.jsonで設定されたプラグイン",
  ...
  "error.chain.checkConfig": "config (jarvis.json) のプロバイダー/モデル名を確認してください",
