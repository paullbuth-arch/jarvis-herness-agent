...
export const dict = {
  ...
  "dialog.provider.jarvis.note": "使用 OpenCode Zen 或 API 密钥连接",
  "dialog.provider.jarvis.tagline": "可靠的优化模型",
  "dialog.provider.jarvisGo.tagline": "适合所有人的低成本订阅",
  ...
  "provider.connect.jarvisZen.line1": "OpenCode Zen 为你提供一组精选的可靠优化模型，用于代码智能体。",
  "provider.connect.jarvisZen.line2": "只需一个 API 密钥，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.jarvisZen.visit.prefix": "访问 ",
  "provider.connect.jarvisZen.visit.link": "jarvis.wq7036/zen",
  "provider.connect.jarvisZen.visit.suffix": " 获取你的 API 密钥。",
  ...
  "dialog.plugins.empty": "在 jarvis.json 中配置的插件",
  ...
  "error.chain.checkConfig": "请检查你的配置 (jarvis.json) 中的 provider/model 名称",
