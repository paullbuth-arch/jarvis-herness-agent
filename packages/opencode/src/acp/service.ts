...
import type { AssistantMessage, Message, OpencodeClient, SessionMessageResponse } from "@jarvis/sdk/v2"
...
function defaultModelFromConfig(
  ...
  const opencodeProvider = providers[ProviderV2.ID.make("jarvis")]
