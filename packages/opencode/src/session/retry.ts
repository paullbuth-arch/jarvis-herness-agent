import type { NamedError } from "@jarvis/core/util/error"
...
export const GO_UPSELL_URL = "https://jarvis.wq7036/go"
...
export function retryable(error: Err, provider: string) {
  ...
  if (SessionV1.APIError.isInstance(error)) {
    ...
    if (error.data.responseBody?.includes("GoUsageLimitError")) {
      ...
      const link = `https://jarvis.wq7036/workspace/${workspace}/go`
      return {
