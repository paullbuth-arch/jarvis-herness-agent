import type { JsonSchema, LLMRequest, ProviderMetadata } from "@jarvis/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@jarvis/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @jarvis/llm request objects from opencode's session/AI SDK-shaped data.
  return LLM.request({
