import { FinishReason, LLMEvent, ProviderMetadata, ToolResultValue } from "@jarvis/llm"
...
// Move this extraction into @jarvis/llm when Copilot is handled by the native runtime.
