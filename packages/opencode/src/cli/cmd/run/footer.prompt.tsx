...
import { normalizePromptContent } from "@jarvis/tui/editor"
...
import { JARVIS_BASE_MODE, useBindings } from "@jarvis/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close Jarvis" } satisfies SlashOption,
    ]
