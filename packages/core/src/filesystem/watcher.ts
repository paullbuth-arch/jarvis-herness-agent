...
import { FileSystemWatcher } from "@jarvis/schema/filesystem-watcher"
...
declare const JARVIS_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof JARVIS_LIBC === "undefined" ? undefined : JARVIS_LIBC
...
const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.JARVIS_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (yield* Flag.JARVIS_EXPERIMENTAL_FILEWATCHER) {
