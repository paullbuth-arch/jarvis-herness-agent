...
import type { Data, Definition, Payload } from "@jarvis/schema/event"
...
import { Durable } from "@jarvis/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@jarvis/schema/event").ID
export type { Data, Definition, Payload } from "@jarvis/schema/event"
