...
import { ToolFailure } from "@jarvis/llm"
...
export const defaultConfigLayer = Layer.sync(ConfigService, () =>
  ConfigService.of({
    provider:
      process.env.JARVIS_WEBSEARCH_PROVIDER === "exa" || process.env.JARVIS_WEBSEARCH_PROVIDER === "parallel"
        ? process.env.JARVIS_WEBSEARCH_PROVIDER
        : undefined,
    enableExa: truthy("JARVIS_EXPERIMENTAL") || truthy("JARVIS_ENABLE_EXA") || truthy("JARVIS_EXPERIMENTAL_EXA"),
    enableParallel: truthy("JARVIS_ENABLE_PARALLEL") || truthy("JARVIS_EXPERIMENTAL_PARALLEL"),
