import { Message, Model, Part, Session, SessionStatus, SnapshotFileDiff, UserMessage } from "@jarvis/sdk/v2"
import { SessionTurn } from "@jarvis/session-ui/session-turn"
import { SessionReview } from "@jarvis/session-ui/session-review"
import { DataProvider } from "@jarvis/session-ui/context"
import { FileComponentProvider } from "@jarvis/ui/context/file"
import { WorkerPoolProvider } from "@jarvis/ui/context/worker-pool"
import { createAsync, query, useParams } from "@solidjs/router"
import { createMemo, createSignal, ErrorBoundary, For, Match, Show, Switch } from "solid-js"
import { Share } from "~/core/share"
import { Logo, Mark } from "@jarvis/ui/logo"
import { IconButton } from "@jarvis/ui/icon-button"
import { ProviderIcon } from "@jarvis/ui/provider-icon"
import { iife } from "@jarvis/core/util/iife"
import { Binary } from "@jarvis/core/util/binary"
import { NamedError } from "@jarvis/core/util/error"
import { DateTime } from "luxon"
import { createStore } from "solid-js/store"
import NotFound from "../[...404]"
import { Tabs } from "@jarvis/ui/tabs"
import { MessageNav } from "@jarvis/session-ui/message-nav"
import { FileSSR } from "@jarvis/session-ui/file-ssr"
...
const ClientOnlyWorkerPoolProvider = clientOnly(() =>
  import("@jarvis/session-ui/pierre/worker").then((m) => ({
                        ...
                        <div class="relative bg-background-stronger w-screen h-screen overflow-hidden flex flex-col">
                          <header class="h-12 px-6 py-2 flex items-center justify-between self-stretch bg-background-base border-b border-border-weak-base">
                            ...
                            <div class="flex gap-3 items-center">
                              ...
                              <IconButton
                                as={"a"}
                                href="https://jarvis.wq7036/discord"
                                target="_blank"
                                icon="discord"
                                variant="ghost"
                              />
