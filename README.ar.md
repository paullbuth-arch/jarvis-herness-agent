...
nix run nixpkgs#opencode           # او github:paullbuth-arch/jarvis-herness-agent لاحدث فرع dev
```
...
يتوفر Jarvis ايضا كتطبيق سطح مكتب. قم بالتنزيل مباشرة من [صفحة الاصدارات](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) او من [jarvis.dev/download](https://jarvis.dev/download).
...
تعرف على المزيد حول [agents](https://jarvis.dev/docs/agents).

### التوثيق

لمزيد من المعلومات حول كيفية ضبط Jarvis، [**راجع التوثيق**](https://jarvis.dev/docs).
