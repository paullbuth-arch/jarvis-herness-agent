...
nix run nixpkgs#opencode           # ou github:paullbuth-arch/jarvis-herness-agent pour la branche dev la plus récente
```
...
Jarvis est aussi disponible en application de bureau. Téléchargez-la directement depuis la [page des releases](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) ou [jarvis.dev/download](https://jarvis.dev/download).
...
En savoir plus sur les [agents](https://jarvis.dev/docs/agents).

### Documentation

Pour plus d'informations sur la configuration d'Jarvis, [**consultez notre documentation**](https://jarvis.dev/docs).
