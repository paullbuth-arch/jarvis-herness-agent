...
nix run nixpkgs#opencode           # або github:paullbuth-arch/jarvis-herness-agent для найновішої dev-гілки
```
...
Jarvis також доступний як десктопний застосунок. Завантажуйте напряму зі [сторінки релізів](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) або [jarvis.dev/download](https://jarvis.dev/download).
...
Дізнайтеся більше про [agents](https://jarvis.dev/docs/agents).

### Документація

Щоб дізнатися більше про налаштування Jarvis, [**перейдіть до нашої документації**](https://jarvis.dev/docs).
