...
nix run nixpkgs#opencode           # eller github:paullbuth-arch/jarvis-herness-agent for nyeste dev-branch
```
...
Jarvis er også tilgjengelig som en desktop-app. Last ned direkte fra [releases-siden](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) eller [jarvis.dev/download](https://jarvis.dev/download).
...
Les mer om [agents](https://jarvis.dev/docs/agents).

### Dokumentasjon

For mer info om hvordan du konfigurerer Jarvis, [**se dokumentasjonen**](https://jarvis.dev/docs).
