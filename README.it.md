...
nix run nixpkgs#opencode           # oppure github:paullbuth-arch/jarvis-herness-agent per l’ultima branch di sviluppo
```
...
Jarvis è disponibile anche come applicazione desktop. Puoi scaricarla direttamente dalla [pagina delle release](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) oppure da [jarvis.dev/download](https://jarvis.dev/download).
...
Jarvis include due agenti integrati tra cui puoi passare usando il tasto `Tab`.
...
Scopri di più sugli [agenti](https://jarvis.dev/docs/agents).

### Documentazione

Per maggiori informazioni su come configurare Jarvis, [**consulta la nostra documentazione**](https://jarvis.dev/docs).

### Contribuire

Se sei interessato a contribuire a Jarvis, leggi la nostra [guida alla contribuzione](./CONTRIBUTING.md) prima di inviare una pull request.

### Costruire su Jarvis

Se stai lavorando a un progetto correlato a Jarvis e che utilizza “opencode” come parte del nome (ad esempio “opencode-dashboard” o “opencode-mobile”), aggiungi una nota nel tuo README per chiarire che non è sviluppato dal team Jarvis e che non è affiliato in alcun modo con noi.
