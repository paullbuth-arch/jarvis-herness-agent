...
nix run nixpkgs#opencode           # または github:paullbuth-arch/jarvis-herness-agent で最新 dev ブランチ
```
...
Jarvis はデスクトップアプリとしても利用できます。[releases page](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) から直接ダウンロードするか、[jarvis.dev/download](https://jarvis.dev/download) を利用してください。
...
[agents](https://jarvis.dev/docs/agents) の詳細はこちら。

### ドキュメント

Jarvis の設定については [**ドキュメント**](https://jarvis.dev/docs) を参照してください。
