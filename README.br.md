...
nix run nixpkgs#opencode           # ou github:paullbuth-arch/jarvis-herness-agent para a branch dev mais recente
```
...
O Jarvis também está disponível como aplicativo desktop. Baixe diretamente pela [página de releases](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) ou em [jarvis.dev/download](https://jarvis.dev/download).
...
Saiba mais sobre [agents](https://jarvis.dev/docs/agents).

### Documentação

Para mais informações sobre como configurar o Jarvis, [**veja nossa documentação**](https://jarvis.dev/docs).
