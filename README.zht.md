...
nix run nixpkgs#opencode           # 或使用 github:paullbuth-arch/jarvis-herness-agent 以取得最新開發分支
```
...
Jarvis 也提供桌面版應用程式。您可以直接從 [發佈頁面 (releases page)](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) 或 [jarvis.dev/download](https://jarvis.dev/download) 下載。
...
了解更多關於 [Agents](https://jarvis.dev/docs/agents) 的資訊。

### 線上文件

關於如何設定 Jarvis 的詳細資訊，請參閱我們的 [**官方文件**](https://jarvis.dev/docs)。
