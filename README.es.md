...
nix run nixpkgs#opencode           # o github:paullbuth-arch/jarvis-herness-agent para la rama dev más reciente
```
...
Jarvis también está disponible como aplicación de escritorio. Descárgala directamente desde la [página de releases](https://github.com/paullbuth-arch/jarvis-herness-agent/releases) o desde [jarvis.dev/download](https://jarvis.dev/download).
...
Más información sobre [agentes](https://jarvis.dev/docs/agents).

### Documentación

Para más información sobre cómo configurar Jarvis, [**ve a nuestra documentación**](https://jarvis.dev/docs).
